...
const AdminHome = () => {
    ...
    return (
        <div className="w-full m-4">
            <h2 className="text-xl md:text-3xl font-semibold flex items-center gap-2 text-custom-color">Hi, {user.displayName}<FaGrinHearts></FaGrinHearts></h2>
            <div className="overflow-x-auto mb-7 lg:mb-24">
